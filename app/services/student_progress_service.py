class StudentProgressService:
    ...
    def evaluate_node(self, node, student_completed_courses):
        ...
        if "university_course" in node:
            ...
            child_results = [self.evaluate_node(child, student_completed_courses) for child in node["groups"]]
    ...
    def evaluate_student_articulation_progress(self, student_completed_courses, articulation_tree):
        """Evaluate whether a student has satisfied the articulation requirements."""
        return self.evaluate_node(articulation_tree, student_completed_courses)
    
    def consolidate_university_courses(self, plan):
